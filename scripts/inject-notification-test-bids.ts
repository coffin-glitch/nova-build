...
async function main() {
  try {
    ...
    // Format: 66666XXXX where XXXX is sequential
    // Change the base number (666660000) for each new test to ensure uniqueness
    const timestamp = Date.now();
    const baseNumber = 666660000; // Changed from 777770000 for this test
