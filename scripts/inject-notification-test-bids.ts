...
async function main() {
  try {
    ...
    // Format: 77777XXXX where XXXX is sequential
    // Change the base number (777770000) for each new test to ensure uniqueness
    const timestamp = Date.now();
    const baseNumber = 777770000; // Changed from 888880000 for this test
