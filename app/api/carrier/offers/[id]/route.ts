  ...
  try {
    ...
    if (action === 'modify') {
      ...
      await sql`
        ...
        VALUES (${id}, ${historyAction}, ${offer.offer_amount}, ${amountInCents}, ${notes || ''}, ${userId})
      `;
      ...
      await sql`
        ...
        VALUES (${id}, 'withdrawn', 'pending', 'withdrawn', ${userId})
      `;
      ...
      await sql`
        INSERT INTO offer_history (offer_id, action, old_status, new_status, performed_by)
        VALUES (${id}, 'accepted_counter', 'countered', 'accepted', ${userId})
      `;
      ...
      await sql`
        INSERT INTO offer_history (offer_id, action, old_status, new_status, performed_by)
        VALUES (${id}, 'rejected_counter', 'countered', 'rejected', ${userId})
      `;
...
export async function DELETE(
  ...
  try {
    ...
    await sql`
      ...
      VALUES (${id}, 'deleted', 'pending', ${userId})
    `;
