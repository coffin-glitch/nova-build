...
export default function FloatingCarrierMessagesButton() {
  ...
  const handleButtonClick = () => {
    ...
    if (!isDragging && dragDuration < 100) { // Only trigger click if not dragging or very short drag
      setIsOpen(!isOpen);
    }
  };
    ...
    <>
      ...
      {isOpen && (
        <>
          ...
          {/* Chat Console */}
          <div 
            className="fixed z-50 w-96 h-[600px] animate-in slide-in-from-bottom-4 duration-500 ease-out floating-carrier-console"
            style={{
